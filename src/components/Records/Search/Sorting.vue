        ...
        methods:
            {
                ...
                checkOnceOrderByExists: function (query) {
                    if (Object.prototype.hasOwnProperty.call(query, "orderBy")) {
                        ...
                        let _label = arrayedQuery[0] === '_score' ? 'best-match' : arrayedQuery[0];
                        let activeFilter = {name: arrayedQuery[0], label:_label, active: false}; // sortName name/best-match-etc
