    ...
    mutations: {
        ...
        setAdditionalInformationSubField(state, additionalInformation) {
            if (additionalInformation.id !== null) {
                ...
                console.log("ONE: " + JSON.stringify(state.sections.additionalInformation.data));
                console.log("TWO: " + JSON.stringify(additionalInformation.fieldName));
                console.log("THREE: " + JSON.stringify(additionalInformation.fieldValue));
                Vue.set(state.sections.additionalInformation.data[additionalInformation.fieldName],
