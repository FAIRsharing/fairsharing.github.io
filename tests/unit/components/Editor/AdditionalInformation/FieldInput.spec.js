  ...
  it("can be mounted without a subfield name", () => {
    wrapper = shallowMount(FieldInput, {
      ...
      propsData: {
        ...
        fieldProps:
          additionalInformationFixture.schema.properties["dataset_deposition"],
      },
    });
  ...
  it("can be mounted with a subfield name with value", () => {
    wrapper = shallowMount(FieldInput, {
      ...
      propsData: {
        ...
        fieldProps:
          additionalInformationFixture.schema.definitions.data_process
            .properties.url,
        subfieldName: "url",
        id: 0,
      },
  ...
  it("can set a field value without a subfield", () => {
    wrapper = shallowMount(FieldInput, {
      ...
      propsData: {
        ...
        fieldProps:
          additionalInformationFixture.schema.properties[
